...
export const translations = {
  en: {
    ...
    "profile.uploadPicture": "Upload a new picture",
    "profile.chooseAsset": "Or choose from your images",
    "profile.noPicture": "No profile picture",
    "profile.removePicture": "Remove picture",
    "profile.avatarAssetTitle": "Profile picture",
    "profile.imageRequired": "The selected file is not a supported image",
    "profile.avatarReady": "Picture selected. Save your profile to apply it.",
    ...
    "passwordReset.forgotLink": "Forgot your password?",
    "passwordReset.requestTitle": "Reset your password",
    "passwordReset.requestDescription": "Enter your email address. If an account exists, you will receive a reset link.",
    "passwordReset.requestSuccess": "If an account exists for this email, a reset link has been sent.",
    ...
    "passwordReset.resetting": "Updating...",
    "passwordReset.reset": "Update password",
    "passwordReset.resetSuccess": "Password updated. You can now sign in.",
    "passwordReset.invalidTitle": "Invalid reset link",
  ...
  it: {
    ...
    "profile.authRequired": "Accesso richiesto",
    "profile.title": "Dati personali",
    "profile.picture": "Foto profilo",
    "profile.uploadPicture": "Carica una nuova foto",
    "profile.chooseAsset": "Oppure scegli tra le tue immagini",
    "profile.noPicture": "Nessuna foto profilo",
    "profile.removePicture": "Rimuovi foto",
    "profile.avatarAssetTitle": "Foto profilo",
    "profile.imageRequired": "Il file selezionato non è un’immagine supportata",
    "profile.avatarReady": "Foto selezionata. Salva il profilo per applicarla.",
    "profile.passwordTitle": "Modifica password",
    "profile.passwordHint": "Lascia vuoti questi campi per mantenere la password attuale.",
    ...
    "passwordReset.forgotLink": "Password dimenticata?",
    "passwordReset.requestTitle": "Reimposta la password",
    "passwordReset.requestDescription": "Inserisci il tuo indirizzo email. Se esiste un account, riceverai un link di reset.",
    "passwordReset.requestSuccess": "Se esiste un account per questa email, è stato inviato un link di reset.",
    "passwordReset.sending": "Invio...",
    "passwordReset.send": "Invia link di reset",
    "passwordReset.resetTitle": "Scegli una nuova password",
    "passwordReset.newPassword": "Nuova password",
    "passwordReset.confirmPassword": "Conferma password",
    "passwordReset.passwordMismatch": "Le password non coincidono",
    "passwordReset.resetting": "Aggiornamento...",
    "passwordReset.reset": "Aggiorna password",
    "passwordReset.resetSuccess": "Password aggiornata. Ora puoi accedere.",
    "passwordReset.invalidTitle": "Link di reset non valido",
